...
מומלץ לנסות יותר
ניתן לפתור באמצעות תרשים זרימה או קוד פייתון
...
הערה:
ההדפסות חייבות להיות באנגלית בדיוק כפי שמופיע כאן
...
הערה:
חובה להשתמש ב־int בכל קלט, לדוגמה:
`number = int(input('enter number? '))`
...
הדפסה באנגלית בלבד, לדוגמה: `avg = 3.7`
